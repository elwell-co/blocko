...
var Container = function Container(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_StyledDiv$2, _extends({
    ...
    _css2: css(["box-sizing:border-box;width:100%;max-width:", ";margin-left:auto;margin-right:auto;position:relative;", " ", " ", ""], size, space && css(["padding-left:", ";padding-right:", ";"], space, space), left && css(["margin-left:0;"]), right && css(["margin-right:0;"]))
  }), children);
};
