...
const Section = ({
  ...
  return /*#__PURE__*/React.createElement(_StyledDiv$3, Object.assign({
    ...
    _css2: css(["box-sizing:border-box;position:relative;min-height:", ";background-color:", ";display:flex;align-items:center;justify-content:center;overflow:hidden;", ""], _height, bg, space && css(["padding-top:calc((3.5vw + 24px) * ", ");padding-bottom:calc((3.5vw + 24px) * ", ");"], space, space))
  }), children);
};
