...
var Cols = function Cols(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_StyledDiv$1, {
    ...
    _css3: css(["min-width:100%;box-sizing:border-box;display:flex;flex-wrap:wrap;", " ", " ", ""], vAlign === 'center' && css(["align-items:center;"]), flip && css(["flex-direction:row-reverse;"]), space && css(["margin:- calc((3.5vw + 24px) * space);& > *{padding:calc((3.5vw + 24px) * space);}"]))
  }), children));
};
