...
function Col(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_StyledDiv, _extends({
    ...
    _css2: _styled.css(["box-sizing:border-box;flex:0 0 100%;width:100%;", ""], widths.map(function (w) {
...
var Container = function Container(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_StyledDiv$2, _extends({
    ...
    _css2: _styled.css(["box-sizing:border-box;width:100%;max-width:", ";margin-left:auto;margin-right:auto;position:relative;", " ", " ", " ", ""], width, textAlign && _styled.css(["text-align:", ";"], textAlign), space && _styled.css(["padding-left:calc((3.5vw + 24px) * ", ");padding-right:calc((3.5vw + 24px) * ", ");"], space, space), left && _styled.css(["margin-left:0;"]), right && _styled.css(["margin-right:0;"]))
  }), children);
};
...
var Section = function Section(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_StyledDiv$3, _extends({
    ...
    _css2: _styled.css(["box-sizing:border-box;position:relative;min-height:", ";background-color:", ";display:flex;align-items:center;justify-content:center;overflow:hidden;", ""], height, bg, space && _styled.css(["padding-top:calc((3.5vw + 24px) * ", ");padding-bottom:calc((3.5vw + 24px) * ", ");"], space, space))
  }), children);
};
