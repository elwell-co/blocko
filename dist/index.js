...
var Cols = function Cols(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_StyledDiv$1, {
    ...
    _css3: _styled.css(["min-width:100%;box-sizing:border-box;display:flex;flex-wrap:wrap;", " ", " ", ""], vAlign === 'center' && _styled.css(["align-items:center;"]), flip && _styled.css(["flex-direction:column-reverse;"]), space && _styled.css(["margin:-", ";& > *{padding:", ";}"], space, space))
  }), children));
};
