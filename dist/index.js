...
var Container = function Container(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_StyledDiv$2, _extends({
    ...
    _css2: _styled.css(["box-sizing:border-box;width:100%;max-width:", ";margin-left:auto;margin-right:auto;", " ", " ", ""], width, space && _styled.css(["padding-left:calc((3.5vw + 24px) * ", ");padding-right:calc((3.5vw + 24px) * ", ");"], space, space), left && _styled.css(["margin-left:0;"]), right && _styled.css(["margin-right:0;"]))
  }), children);
};
